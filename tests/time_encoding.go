...
// Hash: ddcde9be27549f8b7a4ce0f961180e583140e521dfde43f8328aaeab91449742
package tests
...
func (t *TimeType) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (0) 'Timestamp'
	dst = ssz.MarshalUint64(dst, uint64(t.Timestamp.Unix()))
...
func (t *TimeType) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Timestamp'
	t.Timestamp = time.Unix(int64(ssz.UnmarshallUint64(buf[0:8])), 0).UTC()
