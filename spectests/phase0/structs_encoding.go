...
// Hash: b04cb9f60692d4c42af3e721f228cd046e1b6a793560b75c95dc3fb9afaecd5c
package phase0
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.LatestBlockHeader.UnmarshalSSZ(buf[32:144]); err != nil {
		return err
	}
	...
	for ii := 0; ii < 64; ii++ {
		copy(b.BlockRoots[ii][:], buf[144:2192][ii*32:(ii+1)*32])
	}

	// Field (5) 'StateRoots'
	b.StateRoots = make([][32]byte, 64)
	for ii := 0; ii < 64; ii++ {
		copy(b.StateRoots[ii][:], buf[2192:4240][ii*32:(ii+1)*32])
	}

	// Offset (6) 'HistoricalRoots'
	if o6 = ssz.ReadOffset(buf[4240:4244]); o6 > size {
		return ssz.ErrOffset
	}
	...
	if err = b.Eth1Data.UnmarshalSSZ(buf[4244:4316]); err != nil {
		return err
	}

	// Offset (8) 'Eth1DataVotes'
	if o8 = ssz.ReadOffset(buf[4316:4320]); o8 > size || o6 > o8 {
		return ssz.ErrOffset
	}

	// Field (9) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[4320:4328])

	// Offset (10) 'Validators'
	if o10 = ssz.ReadOffset(buf[4328:4332]); o10 > size || o8 > o10 {
		return ssz.ErrOffset
	}

	// Offset (11) 'Balances'
	if o11 = ssz.ReadOffset(buf[4332:4336]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 64; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[4336:6384][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[4336:6384][ii*32:(ii+1)*32]...)
	}

	// Field (13) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 64)
	for ii := 0; ii < 64; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[6384:6896][ii*8 : (ii+1)*8])
	}

	// Offset (14) 'PreviousEpochAttestations'
	if o14 = ssz.ReadOffset(buf[6896:6900]); o14 > size || o11 > o14 {
		return ssz.ErrOffset
	}

	// Offset (15) 'CurrentEpochAttestations'
	if o15 = ssz.ReadOffset(buf[6900:6904]); o15 > size || o14 > o15 {
		return ssz.ErrOffset
	}

	// Field (16) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[6904:6905]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[6904:6905]...)

	// Field (17) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[6905:6945]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[6945:6985]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[6985:7025]); err != nil {
		return err
	}
