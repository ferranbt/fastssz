...
type SyncAggregate struct {
	SyncCommitteeBits      []byte `json:"sync_committee_bits,omitempty" ssz-size:"64"`
...
type SyncCommittee struct {
	Pubkeys         [][]byte `json:"pubkeys,omitempty" ssz-size:"512,48"`
...
type SyncCommitteeContribution struct {
	...
	SubcommitteeIndex uint64 `json:"subcommittee_index,omitempty"`
	AggregationBits   []byte `json:"aggregation_bits,omitempty" ssz-size:"16"`
