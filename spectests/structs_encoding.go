...
// Hash: 3bde180dd8078d35747933b38b3de1b19f3316d09f5ff295a8ef1e212f52221d
package spectests
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if b.CurrentSyncCommitee == nil {
		b.CurrentSyncCommitee = new(SyncCommittee)
	}
...
func (s *SyncCommittee) UnmarshalSSZ(buf []byte) error {
	...
	for ii := 0; ii < 32; ii++ {
		copy(s.PubKeys[ii][:], buf[0:1536][ii*48:(ii+1)*48])
	}
...
func (s *SyncAggregate) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:]
		if err = ssz.ValidateBitlist(buf, 8); err != nil {
			return err
		}
		if cap(s.SyncCommiteeBits) == 0 {
			s.SyncCommiteeBits = make([]byte, 0, len(buf))
		}
		s.SyncCommiteeBits = append(s.SyncCommiteeBits, buf...)
	}
	return err
}
...
func (s *SyncAggregate) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (0) 'SyncCommiteeBits'
	if len(s.SyncCommiteeBits) == 0 {
		err = ssz.ErrEmptyBitlist
		return
	}
	hh.PutBitlist(s.SyncCommiteeBits, 8)
