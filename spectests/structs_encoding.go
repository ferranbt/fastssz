...
// Hash: b7bdd44f9ba93186de4e75fd3ce1caf0ec2c370eaba5155f9e882c7a1fe48b6d
// Version: 0.1.3-dev
package spectests
...
// MarshalSSZ ssz marshals the ExecutionPayloadEIP4844 object
func (e *ExecutionPayloadEIP4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionPayloadEIP4844 object to a target array
func (e *ExecutionPayloadEIP4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(516)
	...
	// Field (10) 'ExtraData'
	if size := len(e.ExtraData); size > 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadEIP4844.ExtraData", size, 32)
		return
	}
	dst = append(dst, e.ExtraData...)
	...
	if size := len(e.Transactions); size > 1048576 {
		err = ssz.ErrListTooBigFn("ExecutionPayloadEIP4844.Transactions", size, 1048576)
		return
	}
	{
		offset = 4 * len(e.Transactions)
	...
	for ii := 0; ii < len(e.Transactions); ii++ {
		if size := len(e.Transactions[ii]); size > 1073741824 {
			err = ssz.ErrBytesLengthFn("ExecutionPayloadEIP4844.Transactions[ii]", size, 1073741824)
			return
		}
		dst = append(dst, e.Transactions[ii]...)
	}
...
// UnmarshalSSZ ssz unmarshals the ExecutionPayloadEIP4844 object
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionPayloadEIP4844 object
func (e *ExecutionPayloadEIP4844) SizeSSZ() (size int) {
	size = 516
...
// HashTreeRoot ssz hashes the ExecutionPayloadEIP4844 object
func (e *ExecutionPayloadEIP4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionPayloadEIP4844 object with a hasher
func (e *ExecutionPayloadEIP4844) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the ExecutionPayloadEIP4844 object
func (e *ExecutionPayloadEIP4844) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(e)
}

// MarshalSSZ ssz marshals the ExecutionPayloadHeaderEIP4844 object
func (e *ExecutionPayloadHeaderEIP4844) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionPayloadHeaderEIP4844 object to a target array
func (e *ExecutionPayloadHeaderEIP4844) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(544)

	// Field (0) 'ParentHash'
	if size := len(e.ParentHash); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.ParentHash", size, 32)
		return
	}
	dst = append(dst, e.ParentHash...)
	...
	// Field (1) 'FeeRecipient'
	if size := len(e.FeeRecipient); size != 20 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.FeeRecipient", size, 20)
		return
	}
	dst = append(dst, e.FeeRecipient...)
	...
	// Field (2) 'StateRoot'
	if size := len(e.StateRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.StateRoot", size, 32)
		return
	}
	dst = append(dst, e.StateRoot...)
	...
	// Field (3) 'ReceiptsRoot'
	if size := len(e.ReceiptsRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.ReceiptsRoot", size, 32)
		return
	}
	dst = append(dst, e.ReceiptsRoot...)
	...
	// Field (4) 'LogsBloom'
	if size := len(e.LogsBloom); size != 256 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.LogsBloom", size, 256)
		return
	}
	dst = append(dst, e.LogsBloom...)
	...
	// Field (5) 'PrevRandao'
	if size := len(e.PrevRandao); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.PrevRandao", size, 32)
		return
	}
	dst = append(dst, e.PrevRandao...)
	...
	// Field (11) 'BaseFeePerGas'
	if size := len(e.BaseFeePerGas); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.BaseFeePerGas", size, 32)
		return
	}
	dst = append(dst, e.BaseFeePerGas...)
	...
	// Field (13) 'BlockHash'
	if size := len(e.BlockHash); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.BlockHash", size, 32)
		return
	}
	dst = append(dst, e.BlockHash...)
	...
	if size := len(e.TransactionsRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.TransactionsRoot", size, 32)
		return
	}
	dst = append(dst, e.TransactionsRoot...)
	...
	// Field (10) 'ExtraData'
	if size := len(e.ExtraData); size > 32 {
		err = ssz.ErrBytesLengthFn("ExecutionPayloadHeaderEIP4844.ExtraData", size, 32)
		return
	}
	dst = append(dst, e.ExtraData...)
...
// UnmarshalSSZ ssz unmarshals the ExecutionPayloadHeaderEIP4844 object
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionPayloadHeaderEIP4844 object
func (e *ExecutionPayloadHeaderEIP4844) SizeSSZ() (size int) {
	size = 544
...
// HashTreeRoot ssz hashes the ExecutionPayloadHeaderEIP4844 object
func (e *ExecutionPayloadHeaderEIP4844) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionPayloadHeaderEIP4844 object with a hasher
func (e *ExecutionPayloadHeaderEIP4844) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()
...
// GetTree ssz hashes the ExecutionPayloadHeaderEIP4844 object
func (e *ExecutionPayloadHeaderEIP4844) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(e)
}
