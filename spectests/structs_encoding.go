...
// Hash: 661401e7af88032da0b2b6f685286a0a52632387042fcb36635cbe6e99851305
// Version: 0.1.4
package spectests
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (5) 'BlockRoots'
	if size := len(b.BlockRoots); size != rootsSize {
		err = ssz.ErrVectorLengthFn("BeaconState.BlockRoots", size, rootsSize)
		return
	}
	for ii := 0; ii < rootsSize; ii++ {
	...
	// Field (6) 'StateRoots'
	if size := len(b.StateRoots); size != rootsSize {
