...
// Hash: 7eee1143ccde81c2a64a8a5d40113925f872b1f6f3d7883711a9cf30717cffbc
package spectests
...
func (e *Eth1Data) UnmarshalSSZ(buf []byte) error {
	...
	if cap(e.BlockHash) == 0 {
		e.BlockHash = make([]byte, 0, len(buf[40:73]))
	}
	e.BlockHash = append(e.BlockHash, buf[40:73]...)
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.Eth1Data.UnmarshalSSZ(buf[4236:4309]); err != nil {
		return err
	}

	// Offset (8) 'Eth1DataVotes'
	if o8 = ssz.ReadOffset(buf[4309:4313]); o8 > size || o6 > o8 {
		return ssz.ErrOffset
	}

	// Field (9) 'Eth1DepositIndex'
	b.Eth1DepositIndex = ssz.UnmarshallUint64(buf[4313:4321])

	// Offset (10) 'Validators'
	if o10 = ssz.ReadOffset(buf[4321:4325]); o10 > size || o8 > o10 {
		return ssz.ErrOffset
	}

	// Offset (11) 'Balances'
	if o11 = ssz.ReadOffset(buf[4325:4329]); o11 > size || o10 > o11 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 64; ii++ {
		if cap(b.RandaoMixes[ii]) == 0 {
			b.RandaoMixes[ii] = make([]byte, 0, len(buf[4329:6377][ii*32:(ii+1)*32]))
		}
		b.RandaoMixes[ii] = append(b.RandaoMixes[ii], buf[4329:6377][ii*32:(ii+1)*32]...)
	}

	// Field (13) 'Slashings'
	b.Slashings = ssz.ExtendUint64(b.Slashings, 64)
	for ii := 0; ii < 64; ii++ {
		b.Slashings[ii] = ssz.UnmarshallUint64(buf[6377:6889][ii*8 : (ii+1)*8])
	}

	// Offset (14) 'PreviousEpochAttestations'
	if o14 = ssz.ReadOffset(buf[6889:6893]); o14 > size || o11 > o14 {
		return ssz.ErrOffset
	}

	// Offset (15) 'CurrentEpochAttestations'
	if o15 = ssz.ReadOffset(buf[6893:6897]); o15 > size || o14 > o15 {
		return ssz.ErrOffset
	}

	// Field (16) 'JustificationBits'
	if cap(b.JustificationBits) == 0 {
		b.JustificationBits = make([]byte, 0, len(buf[6897:6898]))
	}
	b.JustificationBits = append(b.JustificationBits, buf[6897:6898]...)

	// Field (17) 'PreviousJustifiedCheckpoint'
	if b.PreviousJustifiedCheckpoint == nil {
		b.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = b.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[6898:6938]); err != nil {
		return err
	}
	...
	if err = b.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[6938:6978]); err != nil {
		return err
	}
	...
	if err = b.FinalizedCheckpoint.UnmarshalSSZ(buf[6978:7018]); err != nil {
		return err
	}
	...
	{
		buf = tail[o8:o10]
		num, err := ssz.DivideInt2(len(buf), 73, 16)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Eth1DataVotes[ii].UnmarshalSSZ(buf[ii*73 : (ii+1)*73]); err != nil {
				return err
			}
		}
	}
...
func (b *BeaconBlockBody) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.Eth1Data.UnmarshalSSZ(buf[96:169]); err != nil {
		return err
	}

	// Field (2) 'Graffiti'
	copy(b.Graffiti[:], buf[169:201])

	// Offset (3) 'ProposerSlashings'
	if o3 = ssz.ReadOffset(buf[201:205]); o3 > size {
		return ssz.ErrOffset
	}
	...
	// Offset (4) 'AttesterSlashings'
	if o4 = ssz.ReadOffset(buf[205:209]); o4 > size || o3 > o4 {
		return ssz.ErrOffset
	}

	// Offset (5) 'Attestations'
	if o5 = ssz.ReadOffset(buf[209:213]); o5 > size || o4 > o5 {
		return ssz.ErrOffset
	}

	// Offset (6) 'Deposits'
	if o6 = ssz.ReadOffset(buf[213:217]); o6 > size || o5 > o6 {
		return ssz.ErrOffset
	}

	// Offset (7) 'VoluntaryExits'
	if o7 = ssz.ReadOffset(buf[217:221]); o7 > size || o6 > o7 {
		return ssz.ErrOffset
	}
