...
// Hash: 87893daba8096ed9a9f689e05293eb4b45bd6816f5342e3a9218ec20c0cb6f69
package spectests
...
// MarshalSSZ ssz marshals the BeaconBlockV3 object
func (b *BeaconBlockV3) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockV3 object to a target array
func (b *BeaconBlockV3) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf

	return
}

// UnmarshalSSZ ssz unmarshals the BeaconBlockV3 object
func (b *BeaconBlockV3) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 0 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockV3 object
func (b *BeaconBlockV3) SizeSSZ() (size int) {
	size = 0
	return
}

// HashTreeRoot ssz hashes the BeaconBlockV3 object
func (b *BeaconBlockV3) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockV3 object with a hasher
func (b *BeaconBlockV3) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
